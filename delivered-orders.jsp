...
<head>
    ...
    <title>AyurCart | Manage Delivered Orders</title>
		...
		<div id="layoutSidenav_content">
        	<main>
            	<div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                    	<div class="card-header"><i class="fas fa-table me-1"></i>Delivered Order Details</div>
						<div class="card-body">
                        	<table id="datatablesSimple">
                            	<thead>
                              	...
                              	<tbody>
<% 
	ResultSet query = con.createStatement().executeQuery("SELECT orders.id,orderNumber,totalAmount,orderStatus,orderDate,users.name,users.contactno FROM orders join users on users.id=orders.userId where orderStatus='Delivered'");
	int cnt=1;
	while(query.next()){
%>  
									<tr>
