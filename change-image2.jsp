...
<% 
	...
	query.next();
%>                                 
							<form  method="post" action="UpdateProductImage2" enctype="multipart/form-data">                                
								<input type="hidden" name="name" value='<%=query.getString("productImage2")%>'>
								...
								<div class="row" style="margin-top:1%;">
									...
									<div class="col-4"><img src='productImages/<%=query.getString("productImage2")%>' width="250"><br></div>
								</div>
								<div class="row" style="margin-top:1%;">
									<div class="col-2">Product Image 2</div>
