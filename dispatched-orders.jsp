...
<head>
    ...
    <title>AyurCart | Manage Dispatched Orders</title>
						...
						<div class="card-body">
                        	<table id="datatablesSimple">
                            	<thead>
                              	...
                              	<tbody>
<% 
	ResultSet query = con.createStatement().executeQuery("SELECT orders.id,orderNumber,totalAmount,orderStatus,orderDate,users.name,users.contactno FROM orders join users on users.id=orders.userId where orderStatus='Dispatched'");
	int cnt=1;
	while(query.next()){
%>  
									<tr>
