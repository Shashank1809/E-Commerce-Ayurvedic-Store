...
<head>
    ...
    <title>AyurCart | Category wise Shop </title>
...
<% 
	...
	ResultSet query = con.createStatement().executeQuery("select category.id as catid,category.categoryName from category where id="+cid);
	while(query.next()){ 
%>
			<div class="text-center text-white">
            	<h1 class="display-4 fw-bolder"><%=query.getString("categoryName")%></h1>
...
<% 
	query = con.createStatement().executeQuery("select products.id as pid,products.productImage1,products.productName,products.productPriceBeforeDiscount,products.productPrice from products where categoryId="+cid+" order by pid desc");
	if(query.next()){
		do{
%> 
				<div class="col mb-5">
