...
<% 
	...
	query.next();
%>                                 
							<form  method="post" action="UpdateProductImage3" enctype="multipart/form-data">                                
								...
								<div class="row" style="margin-top:1%;">
									...
									<div class="col-4"><img src='productImages/<%=query.getString("productImage3")%>' width="250"><br></div>
								</div>
								<div class="row" style="margin-top:1%;">
									<div class="col-2">Product Image 3</div>
